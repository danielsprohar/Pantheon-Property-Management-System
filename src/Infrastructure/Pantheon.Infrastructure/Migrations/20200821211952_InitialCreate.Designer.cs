...
namespace Pantheon.Infrastructure.Migrations
{
    ...
    [Migration("20200821211952_InitialCreate")]
            ...
            modelBuilder.Entity("Pantheon.Core.Domain.Models.Invoice", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            BillingPeriodEnd = new DateTime(2020, 8, 22, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            BillingPeriodStart = new DateTime(2020, 8, 21, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            CreatedOn = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            DueDate = new DateTime(2020, 8, 21, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            EmployeeId = 1,
                            InvoiceStatusId = 1,
                            ModifiedBy = 0,
                            ModifiedOn = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
